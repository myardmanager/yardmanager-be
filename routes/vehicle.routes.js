...
router.delete("/all", verifyToken, checkRole(true), deleteAllVehicles);
...
router.get("/all/inventory", verifyToken, checkRole(true), addAllVehiclesToInventory);
